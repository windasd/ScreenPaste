...
- **Lupe** — den zu vergrößernden Bereich aufziehen; die vergrößerte Ansicht wird direkt daneben platziert: Rechteck / abgerundet / Kreis, einstellbarer Zoom (1,2–10×), Rahmenstärke und -farbe, Verbindungslinie, Schatten, Glätten (aus zeigt das harte Pixelraster) sowie die Wahl, ob andere Anmerkungen mit vergrößert werden; die Ansicht **und der Rahmen des Quellbereichs lassen sich jederzeit verschieben** — den Rahmen zu verschieben ändert das Vergrößerte, die Verbindungslinie richtet sich neu aus; das Mausrad ändert den Zoom der ausgewählten Lupe
