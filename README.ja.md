...
- **拡大表示** — 拡大したい範囲をドラッグで囲むと、その横に拡大ビューが配置されます：四角形 / 角丸 / 円、倍率（1.2〜10 倍）・枠線の太さと色・引き線・影・滑らか（オフでハードなピクセル格子）、拡大内容に他の注釈を含めるかを設定可能。拡大ビューと**元の範囲の枠はどちらもいつでもドラッグで移動できます** — 枠を動かせば拡大される内容が変わり、引き線も新しい位置を指し直します。選択中はホイールで倍率を変更できます
